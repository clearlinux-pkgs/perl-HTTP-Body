...
%package man
Summary: man components for the perl-HTTP-Body package.
Group: Default

%description man
man components for the perl-HTTP-Body package.
...
mkdir -p %{_topdir}/BUILD/HTTP-Body-1.22/deblicense/
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/HTTP/Body.pm
/usr/lib/perl5/site_perl/5.26.1/HTTP/Body/MultiPart.pm
/usr/lib/perl5/site_perl/5.26.1/HTTP/Body/OctetStream.pm
/usr/lib/perl5/site_perl/5.26.1/HTTP/Body/UrlEncoded.pm
/usr/lib/perl5/site_perl/5.26.1/HTTP/Body/XForms.pm
/usr/lib/perl5/site_perl/5.26.1/HTTP/Body/XFormsMultipart.pm
